...
def extend_diffusion_pipeline(pipeline_constructor: Type[DiffusionPipeline]) -> Type[DiffusionPipeline]:
    ...
    class PuLIDPipeline(pipeline_constructor):
        ...
        def __call__(self, *args, image_embedding, id_scale: float = 1, cross_attention_kwargs: dict = {}, **kwargs):
            return super().__call__(*args, **kwargs, cross_attention_kwargs={'id_embedding': image_embedding, 'id_scale': id_scale, **cross_attention_kwargs})
